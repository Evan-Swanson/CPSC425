...
function render()
{
    ...
    setUniform3f(program, "lightDir", lx, ly, 1.0);
    setUniform3f(program, "lightColor", 1.0, 1.0, 0.8);
    setUniform3f(program, "ambientColor", 0.2, 0.2, 0.3);
    setUniform3f(program, "surfaceDiffuse", 0.5, 0.5, 1.0);
    setUniform3f(program, "surfaceSpec", 0.8, 0.8, 0.8);


    setUniform3f(program, "lightDir2", 2* Math.sin(angle), 2*Math.cos(angle), -1.0);
    setUniform3f(program, "lightColor2", 0.7, 0.0, 0.3);
    setUniform3f(program, "ambientColor2", 0.2, 0.2, 0.3);
    setUniform3f(program, "surfaceDiffuse2", 0.8, 0.8, 0.8);
    setUniform3f(program, "surfaceSpec2", 0.8, 0.8, 0.8);
